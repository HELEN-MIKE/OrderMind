...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "guide_step_1_body": "点击“订单文件”，选择客户发来的 TXT、CSV 或 XLSX 订单。第一版会在本机读取文件，不会上传到云端。",
        ...
        "supported_formats": "支持 TXT / CSV / XLSX",
        "validation_scope": "校验范围",
        "validation_scope_value": "数量、金额、格式、必填项",
        "roadmap": "后续路线",
        "roadmap_value": "DOCX / PDF / OCR / 本地 AI",
        "result_title": "审单结果",
        "upload_again": "重新上传",
        "line_count": "明细行",
        "errors": "错误",
    ...
    "en": {
        ...
        "guide_step_1_body": "Click Order File and choose a customer TXT, CSV, or XLSX order. The first version reads the file locally and does not upload it to the cloud.",
        ...
        "supported_formats": "TXT / CSV / XLSX supported",
        "validation_scope": "Validation Scope",
        "validation_scope_value": "Quantity, amount, format, required fields",
        "roadmap": "Roadmap",
        "roadmap_value": "DOCX / PDF / OCR / local AI",
